  ...
  <div>
    <div class="container" v-if="cards.length > 0 || charts.length > 0">
      <div class="columns is-mobile is-multiline">
        ...
        <slider-button-card v-for="card in getParticularCards('slider-button')" :key="card.id" :card="card"></slider-button-card>
      </div>
      <div class="columns is-mobile is-multiline">
...
import SliderButtonCard from '@/components/SliderButtonCard.vue';
